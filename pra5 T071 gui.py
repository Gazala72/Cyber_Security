...
def exchange():
    try:
        ...
        if shared1 == shared2:
            result.config(
                text="KEY EXCHANGE SUCCESSFUL\nGazala and Shreya have the same secret key.",
                fg="green"
            )
        else:
            result.config(
