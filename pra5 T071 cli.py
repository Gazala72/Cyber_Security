...
def main():
    ...
    print("\nGazala Private Key:", alice_private)
    print("Gazala Public Key:", alice_public)

    print("\nShreya Private Key:", bob_private)
    print("Shreya Public Key:", bob_public)

    print("\nGazala Shared Key:", alice_shared)
    print("Shreya Shared Key:", bob_shared)
